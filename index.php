...
<!--                </li>-->
<!--                <li>-->
<!--                    <a href="php/dashboard.php" class="nav-link text-white">-->
<!--                        <svg xmlns="http://www.w3.org/2000/svg" class="bi d-block mx-auto mb-1" width="24" height="24" fill="currentColor" viewBox="0 0 16 16">-->
...
<!--                </li>-->
<!--                <li>-->
<!--                    <a href="php/orders.php" class="nav-link text-white">-->
<!--                        <svg xmlns="http://www.w3.org/2000/svg" class="bi d-block mx-auto mb-1" width="24" height="24" fill="currentColor" viewBox="0 0 16 16">-->
...
<!--                </li>-->
<!--                <li>-->
<!--                    <a href="php/products.php" class="nav-link text-white">-->
...
<div class="container">
    <header class="d-flex flex-wrap align-items-center justify-content-center justify-content-md-between py-3 mb-4 border-bottom">
        ...
        <ul class="nav col-12 col-md-auto mb-2 justify-content-center mb-md-0">
            ...
            <li><a href="#" class="nav-link px-2 link-dark">À propos</a></li>
        </ul>
