                  ...
                  echo '<tr>
                                  ...
                                  <td>'.$ttc.'</td>
                                    <td><div class="btn-group" role="group" aria-label="Basic mixed styles example">
                                            ...
                                            <button onclick="productDelete('.$ref.')" class="btn btn-sm btn-outline-danger"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" class="bi bi-x-circle" viewBox="0 0 16 16">
...
<script>
function productDelete(reference) {
var r = confirm("Confirmer la suppression?");
if (r == true) {
window.location.replace("productdelete.php?ref="+ reference);
}
}
</script>
