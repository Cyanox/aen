        ...
        <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4 mx-auto">
            ...
            <table class="table table-dark table-striped table-hover">
                ...
                <tr>
                    ...
                    <?php
                    if ($userRank == 0){
                    echo '<th scope="col"><a href="useradd.php" type="button" class="btn btn-sm align-items-center btn-outline-success"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" class="bi bi-plus-circle-dotted" viewBox="0 0 16 16">
