...
$product = getOneProductId($product);
=======
$id = [
        'id' => $_GET['ref']
];
...
<head>
    ...
    <title>Modification de services</title>
...
<div class="container">
    <main>
        ...
        <div class="col-md-7 col-lg-8">
            ...
            <form method="POST" action="producteditprocess.php?ref=<?php echo $_GET['ref']; ?>" class="row g-3">
                <div class="col-md-4">
                    ...
                    <div class="input-group">
                        ...
                        <input type="text" class="form-control" id="ref" name="ref" value="<?php echo $_GET['ref']; ?>" required>
                    </div>
                </div>
                ...
                <div class="col-md-4">
                    ...
                    <div class="input-group">
                        <input type="text" class="form-control" id="ht" name="ht" value="<?php echo $ht; ?>" required>
                    </div>
                </div>
                ...
                <div class="col-md-3">
                    ...
                    <div class="input-group">
                        <input type="text" class="form-control" id="tva" name="tva" value="<?php echo $tva; ?>" required>
                    </div>
                </div>
                ...
                <div class="col-md-3">
                    ...
                    <div class="input-group">
                        <input type="text" class="form-control" id="ttc" name="ttc" value="<?php echo $ttc; ?>" required>
                    </div>
                </div>
